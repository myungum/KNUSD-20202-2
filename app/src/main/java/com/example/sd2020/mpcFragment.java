...
public class mpcFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        view=inflater.inflate(R.layout.activity_fragment_mypage_child, container, false);
        bt_logout=view.findViewById(R.id.bt_child_logout);
        bt_change=view.findViewById(R.id.bt_change_information_child);

        tv_mp_name = view.findViewById(R.id.tv_mc_name);
        tv_mp_id = view.findViewById(R.id.tv_mc_id);
        tv_mp_rel = view.findViewById(R.id.tv_mc_rel);
        tv_mp_tel = view.findViewById(R.id.tv_mc_tel);
